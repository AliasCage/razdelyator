...
var Tutorial2 = new Phaser.Class({
    ...
    preload: function () {
        ...
        //7
        this.load.image('middle7', 'tutorial/tut7/middle.png');
        this.load.image('top7', 'tutorial/tut7/top.png');
    },
    ...
    create: function () {
        ...
        if (DEVICE_SIZE === 1) {
            ...
            this.add.graphics().fillStyle(COLOR_RUE_DARK, 1).fillRect(0, 0, GLOBAL_WIDTH, GLOBAL_HEIGHT);
        }
        ...
        function createNewTut(tutScene) {
            if (numTut === 1) {
                ...
                trash4 = tutScene.add.sprite(midle_window - (bg_width / 3), GLOBAL_HEIGHT * 0.60, 'b19').setOrigin(0.5, 0.5)
                    .setScale(tutScale).setAlpha(0);
                tutScene.tweens.add({
                    targets: trash4,
                    alpha: 1,
                ...
                trash3 = tutScene.add.sprite(midle_window + (bg_width / 3), GLOBAL_HEIGHT * 0.60, 'g4').setOrigin(0.5, 0.5)
                    .setScale(tutScale).setAlpha(0);
                tutScene.tweens.add({
                    targets: trash3,
                    alpha: 1,
            ...
            if (numTut === 6) {
                ...
                textTypeTrash3 = tutScene.add.sprite(midle_window, GLOBAL_HEIGHT / 3, 'text_slow')
                    .setOrigin(0.5, 0.5).setScale(tutScale).setAlpha(0);
                tutScene.tweens.add({
                    targets: textTypeTrash3,
                    alpha: 1,
                    ease: 'Linear',
                ...
                textTypeTrash4 = tutScene.add.sprite(midle_window, GLOBAL_HEIGHT / 6, 'text_clear')
                    .setOrigin(0.5, 0.5).setScale(tutScale).setAlpha(0);
                tutScene.tweens.add({
                    targets: textTypeTrash4,
                    alpha: 1,
